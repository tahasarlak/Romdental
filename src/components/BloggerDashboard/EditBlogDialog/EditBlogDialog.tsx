...
import styles from './EditBlogDialog.module.css';
...
const EditBlogDialog: React.FC<EditBlogDialogProps> = ({ open, onClose, postId }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth className={styles.dialog}>
      <DialogTitle className={styles.dialogTitle}>ویرایش پست</DialogTitle>
